            ...
            <div className="flex-1 flex overflow-hidden">
                ...
                <main className="flex-1 p-4 md:p-8 flex flex-col items-center justify-center overflow-hidden relative">
                    <div className="w-full max-w-4xl h-full flex flex-col items-center justify-center">
                        ...
                        >
                            <h2 className="text-[34px] md:text-[46px] font-wizard tracking-widest text-[#FFD700] mb-4">
                                Choose Your Quest
                            </h2>
                            ...
                            {problems.map((prob) => (
                                ...
                                >
                                    <div className="flex items-center gap-3 mb-4">
                                        ...
                                        <h3 className="text-lg font-wizard text-white leading-tight group-hover:text-[#FFD700] transition-colors pt-1">
                                            {prob.title}
                                        </h3>
                                    </div>
                        ...
                        <div className="mt-12">
                            <button
                                ...
                                className="px-16 py-4 rounded-2xl bg-gradient-to-r from-[#8a6e2e] to-[#d4af37] text-black font-wizard text-[22px] hover:from-[#d4af37] hover:to-[#FFD700] shadow-[0_0_30px_rgba(212,175,55,0.3)] transition-all disabled:opacity-30 disabled:cursor-not-allowed hover:scale-105 active:scale-95 tracking-widest"
                            >
                        ...
                        {showConfirm && (
                            ...
                            >
                                ...
                                >
                                    ...
                                    <h3 className="text-[28px] font-wizard tracking-widest text-[#FFD700] mb-4">Confirm Your Choice</h3>
                                    ...
                                    <div className="flex gap-4">
                                        <button
                                            ...
                                            className="flex-1 py-3 rounded-xl border border-[#d4af37]/30 text-[#d4af37] font-wizard hover:bg-[#d4af37]/10 transition-all tracking-widest text-lg"
                                        >
                                            Return
                                        </button>
                                        <button
                                            onClick={() => { setShowConfirm(false); handleConfirm(); }}
                                            className="flex-1 py-3 rounded-xl bg-[#d4af37] text-black font-wizard hover:bg-[#FFD700] transition-all tracking-widest text-lg"
                                        >
                                            Confirm
                                        </button>
                                    </div>
                        ...
                        {isConfirmed && (
                            ...
                            >
                                ...
                                >
                                    ...
                                    <h3 className="text-[46px] font-wizard tracking-widest text-[#FFD700] mb-6">Manifestation Complete</h3>
                                    <p className="text-lg text-gray-400 font-wizard italic">
