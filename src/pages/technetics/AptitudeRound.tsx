...
const QUESTIONS = [
    ...
    {
        id: 5,
        question: "A magical server has a capacity of 1000 requests. Currently, it is at 85% capacity. If each user adds 5 requests, how many more users can be accommodated before it hits 100%?",
        options: ["20", "30", "40", "50"],
        correct: 1
    },
    {
        id: 6,
        question: "If 5 wizards can harvest 5 mandrakes in 5 minutes, how many wizards are required to harvest 100 mandrakes in 100 minutes?",
        options: ["5", "20", "50", "100"],
        correct: 0
    },
    {
        id: 7,
        question: "Select the missing number in the sequence: 7, 10, 8, 11, 9, 12, ?",
        options: ["7", "10", "12", "13"],
        correct: 1
    },
    {
        id: 8,
        question: "If 'POTTER' is coded as 'QPUTFS' in a cryptic scroll, how is 'HARRY' coded in the same logic?",
        options: ["IBSSZ", "JBSSZ", "IBSRZ", "IASRZ"],
        correct: 0
    },
    {
        id: 9,
        question: "A digital quill can write 300 words in 15 minutes. How many words can it write in 2 hours at the same speed?",
        options: ["2400", "2000", "1800", "3000"],
        correct: 0
    },
    {
        id: 10,
        question: "In a binary search through 64 sorted magical scrolls, what is the maximum number of comparisons needed to find a specific scroll?",
        options: ["6", "7", "8", "64"],
        correct: 0
    }
];
        ...
        return (
            <div className="h-screen w-full bg-[#050b0b] flex items-center justify-center p-4">
                ...
                >
                    ...
                    <h1 className="text-[46px] font-wizard text-white mb-4 tracking-wider">Competition Frozen</h1>
                ...
                <div className="flex items-center gap-6">
                    ...
                    <div className="flex items-center gap-3 pl-4 border-l border-[#d4af37]/20">
                        <div className="text-right flex flex-col">
                            ...
                            <span className="text-xs text-white font-bold leading-none">user@technetics.com</span>
                        </div>
                        <button
                    ...
                    <div className="space-y-10 relative before:absolute before:left-[19px] before:top-2 before:bottom-2 before:w-px before:bg-[#d4af37]/10">
                        ...
                        <div className="relative flex gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-[10px] text-gray-400">10 Magic Riddles</p>
                            </div>
                        </div>
                    ...
                    <div className="w-full max-w-4xl h-full flex flex-col">
                        ...
                        >
                            ...
                            <div className="flex-1 overflow-hidden pr-2">
                                <div className="text-gray-200 font-sans leading-relaxed mb-6 whitespace-pre-wrap text-lg md:text-[22px]">
                                ...
                                <div className="space-y-2">
                                    {QUESTIONS[currentQuestion].options.map((option, idx) => (
                                        ...
                                        >
                                            ...
                                            <span className={`text-base md:text-lg transition-colors ${answers[currentQuestion] === idx ? 'text-white font-bold' : 'text-gray-400 group-hover:text-gray-200'
                                                }`}>
                                                {option}
                                            </span>
                                        </button>
                        ...
                        <div className="flex justify-between items-center py-4 shrink-0">
                            ...
                            {currentQuestion === QUESTIONS.length - 1 ? (
                                <button
                                    ...
                                    className="flex items-center gap-3 px-8 py-1.5 rounded-xl bg-linear-to-r from-[#8a6e2e] to-[#d4af37] text-black font-wizard hover:from-[#d4af37] hover:to-[#FFD700] shadow-[0_0_20px_rgba(212,175,55,0.4)] transition-all text-lg disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                                ...
                                <button
                                    onClick={() => setCurrentQuestion(prev => prev + 1)}
                                    className="flex items-center gap-3 px-8 py-1.5 rounded-xl bg-linear-to-r from-[#8a6e2e] to-[#d4af37] text-black font-wizard hover:from-[#d4af37] hover:to-[#FFD700] shadow-[0_0_20px_rgba(212,175,55,0.4)] transition-all text-lg"
                                >
                                    <span className="text-lg mt-1 px-2">Next</span>
