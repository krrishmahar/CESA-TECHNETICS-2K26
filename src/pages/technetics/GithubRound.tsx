            ...
            <header className="h-16 border-b border-[#d4af37]/20 bg-[#051112]/90 flex items-center justify-between px-6 z-10 backdrop-blur-md shrink-0">
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex flex-col border-l border-[#d4af37]/20 pl-4 py-1">
                        ...
                        <span className="text-[9px] text-gray-500 font-black uppercase tracking-[0.2em] mt-1 opacity-70">GitHub Sync Round</span>
                    </div>
                </div>
                        ...
                        <div className="relative flex gap-4">
                            ...
                            <div>
                                <div className="flex items-center gap-2 mb-1">
                                    <h3 className="text-xs font-black text-[#FFD700] uppercase tracking-wider">GitHub Sync</h3>
                ...
                <main className="flex-1 p-4 md:p-8 flex flex-col items-center justify-center overflow-hidden">
                    <div className="w-full max-w-4xl h-full flex flex-col">
                        ...
                        >
                            ...
                            <h2 className="text-[34px] md:text-[46px] font-wizard tracking-widest text-[#FFD700] mb-6">
                                The Cursed Repository
                            </h2>

                            <p className="text-gray-400 font-sans leading-relaxed mb-10 text-lg md:text-[22px] max-w-2xl mx-auto">
                            ...
                            <div className="bg-black/40 border border-[#d4af37]/20 rounded-2xl p-6 mb-12 flex flex-col md:flex-row items-center justify-between gap-6 hover:border-[#d4af37]/40 transition-all">
                                <div className="flex items-center gap-5">
                                    ...
                                    <div className="text-left">
                                        ...
                                        <p className="text-white font-code text-base break-all tracking-tight">github.com/kc-conquers-code11/CESA-TECHNETICS-2K26</p>
                                    </div>
                                </div>
                                <a
                            ...
                            <div className="space-y-5 text-left max-w-2xl mx-auto w-full">
                                ...
                                <div className="relative group">
                                    <input
                                        ...
                                        className="w-full bg-black/60 border-2 border-[#d4af37]/20 rounded-2xl px-6 py-6 text-lg text-white placeholder:text-gray-600 focus:border-[#d4af37]/60 focus:outline-none transition-all shadow-[inset_0_2px_10px_rgba(0,0,0,0.5)] group-hover:border-[#d4af37]/30"
                                    />
                            ...
                            <div className="mt-14 flex justify-center">
                                <button
                                    ...
                                    className="flex items-center gap-4 px-12 py-4 rounded-2xl bg-gradient-to-r from-[#8a6e2e] to-[#d4af37] text-black font-wizard font-bold text-[22px] hover:from-[#d4af37] hover:to-[#FFD700] shadow-[0_0_30px_rgba(212,175,55,0.3)] transition-all disabled:opacity-30 disabled:cursor-not-allowed hover:scale-105 active:scale-95"
                                >
