...
import { Loader2, X, Cpu, AlertTriangle, Eye, Trophy, RefreshCw, Clock, FastForward } from 'lucide-react';
                        ...
                        {inspectionLoading ? (
                            ...
                            <Tabs defaultValue="coding" className="w-full h-full flex flex-col">
                                <TabsList className="bg-zinc-900 border border-zinc-800 w-fit mb-6">
                                    <TabsTrigger value="coding">Coding Round</TabsTrigger>
                                ...
                                <TabsContent value="flowchart" className="flex-1">
                                    <div className="bg-zinc-900 p-6 rounded-xl border border-zinc-800 h-full overflow-auto">
                                        <pre className="text-xs font-mono text-zinc-400 whitespace-pre-wrap">
                                            {JSON.stringify(inspectedUser?.flowchart?.nodes || "No Flowchart Data", null, 2)}
                                        </pre>
                                    </div>
                                </TabsContent>
